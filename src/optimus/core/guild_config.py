...
class GuildConfig:
    ...
    def should_scan(
        ...
        *,
        ...
        Deliberately has no per-user opt-out. Scanning covers images posted
        publicly in a server whose operator installed the bot; a member-triggered
        exemption would be a self-serve immunity grant, not a privacy control.
        Only a moderator can exempt someone, via ``trusted_users``.
        """
